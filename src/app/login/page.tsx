...
import { Shield, Lock, Eye, CheckCircle, AlertCircle, Sparkles } from 'lucide-react';
...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center px-4 relative overflow-hidden">
      ...
      <Suspense
        fallback={
          <div className="w-full max-w-md bg-slate-900/80 border border-slate-800 rounded-2xl p-8 flex items-center justify-center">
